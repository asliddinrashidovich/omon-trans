...
function Feature() {
  ...
  return (
    <section id="feature" className="px-3 md:px-10 pb-[40px] md:pb-[70px]">
        <div className="max-w-[1368px] mx-auto">
            ...
            <div className="flex flex-col gap-[20px]">
                {featureData.map(item => (
                    <div data-aos="fade-up" key={item.title} className="relative bg-[#fff] border-t-[15px] md:border-t-[0] border-l-[0] md:border-l-[15px] rounded-[40px] border-[#1A00E1] p-[30px] pb-[100px] md:p-[30px] flex gap-[25px] md:flex-row flex-col items-center">
