...
function Hero() {
  ...
  return (
    <section id="home"  className="px-3 md:px-10 py-[10px] hero h-[100vh] lg:h-[840px]">
        <div className="max-w-[1368px] mx-auto flex lg:items-center h-full">
            <div data-aos="fade-up" className="max-w-[500px] md:max-w-[658px] mt-[150px] lg:mt-[0]">
                ...
                <div className="flex min-[370px]:flex-row flex-col min-[370px]:items-center gap-[15px] ">
                    ...
                    <a href="tel:+998999882112" className="py-[8px] md:py-[15px] px-[20px] md:px-[50px] rounded-[15px] text-[#000] border-[3px] border-[#1E2AAE] cursor-pointer">{t("contact")}</a>
                </div>
            </div>
        </div>
    </section>
