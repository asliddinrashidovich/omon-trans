    ...
    <section id="Biz Haqimizda" className="px-3 md:px-10 py-[40px] md:py-[70px]">
        <div className="max-w-[1368px] mx-auto">
            ...
            <div className="grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-2 gap-[10px] mb-[10px]">
                <div data-aos="zoom-in-right" className="py-[26px] md:py-[42px] relative my-box px-[26px] md:px-[35px] border-[#0C114666] border-[1px] border-dashed rounded-[50px]">
                ...
                <div data-aos="zoom-in-left" className="rounded-[23px] overflow-hidden border-[#0C114666] border-[1px] border-dashed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[5px]">
                <div data-aos="zoom-out-down"  className="relative border-[1px] border-[#1A00E166] border-dashed rounded-[50px] h-[228px] md:h-[338px] flex items-center justify-center flex-col gap-[6px]">
