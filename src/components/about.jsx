...
function About() {
  ...
  return (
    <section id="about" className="px-3 md:px-10 py-[40px] md:py-[70px]">
        <div className="max-w-[1368px] mx-auto">
            ...
            <div className="grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-2 gap-[10px] mb-[10px]">
                <div data-aos="fade-up" className="max-[450px]:pb-[100px] py-[26px] md:py-[160px] relative my-box px-[26px] md:px-[35px] border-[#0C114666] border-[1px] border-dashed rounded-[50px]">
                ...
                <div data-aos="fade-up" className="rounded-[23px] overflow-hidden border-[#0C114666] border-[1px] border-dashed">
            ...
            <div  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[5px]">
                <div data-aos="fade-up" className="relative py-[150px] md:py-[0]  border-[1px] border-[#1A00E166] border-dashed rounded-[50px] h-[228px] md:h-[338px] flex items-center justify-center flex-col gap-[6px]">
