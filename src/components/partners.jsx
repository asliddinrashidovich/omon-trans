...
function Partners() {
  ...
  return (
     <section id="partners" className="px-3 md:px-10 pb-[40px] md:pb-[70px]">
        <div className="max-w-[1368px] mx-auto">
            <div data-aos="fade-up" className="flex justify-center">
                <div className="flex justify-center flex-col items-center mb-[28px] md:mb-[70px] py-[10px] sm:py-[15px] px-[40px] sm:px-[60px] text-center bg-[#1A00E1] rounded-[35px]">
                    <h2 className="text-[35px] lg:text-[55px] font-[700]  text-[#fff]">{t("partners")}</h2>  
            ...
            <div className="relative bg-[#fff] rounded-[50px] p-[30px] md:p-[60px]">
                <h3 className="text-[20px] md:text-[25px] font-[700] leading-[122%] text-center mb-[20px] md:mb-[70px]">{t("partnersTitle")}</h3>
