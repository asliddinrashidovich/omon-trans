  ...
  return (
    <section id="contact" className="px-3 md:px-10 pb-[40px] md:pb-[70px]">
        <div className="max-w-[1368px] mx-auto grid grid-cols-1 min-[1000px]:grid-cols-2 items-center gap-[24px]">
            <div data-aos="fade-up-right" className="relative rounded-[50px] bg-[#fff] pt-[26px] pb-[112px] md:py-[171px] px-[20px] md:px-[30px]">
            ...
            <div data-aos="fade-up-left" className="bg-[#fff] py-[33px] px-[15px] sm:px-[43px] rounded-[50px]">
