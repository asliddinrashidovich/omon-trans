        ...
        <div className="max-w-[1368px] mx-auto grid grid-cols-1 min-[1000px]:grid-cols-2 items-center gap-[24px]">
            ...
            <div className="bg-[#fff] py-[33px] px-[15px] sm:px-[43px] rounded-[50px]">
                ...
                <form>
                    ...
                    <button className="text-[25px] md:text-[35px] font-[700] w-full bg-[#1A00E1] rounded-[50px] text-[#fff] py-[13px] md:py-[22px] cursor-pointer">Yuborish</button>
                </form>
            </div>
        </div>
    </section>
