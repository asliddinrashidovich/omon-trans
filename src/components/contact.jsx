  ...
  return (
    <section id="contact " className="px-3 md:px-10 pb-[40px] md:pb-[70px]">
        <div className="max-w-[1368px] mx-auto grid grid-cols-1 min-[1000px]:grid-cols-2 items-center gap-[24px]">
            <div data-aos="fade-up" className="relative rounded-[50px] bg-[#fff] pt-[26px] pb-[112px] md:py-[171px] px-[20px] md:px-[30px]">
            ...
            <div data-aos="fade-up" className="bg-[#fff] py-[33px] px-[15px] sm:px-[43px] rounded-[50px]">
                <hr className="border-[#1A00E1] mx-auto border-[3px] md:border-[6px] h-[0] w-[150px] sm:w-[200px] md:w-[301px] mb-[43px]"/>
                <form onSubmit={onSubmit}>
                    <input required value={name} onChange={(e) => setName(e.target.value)} type="text" name="name" className="mb-[23px] rounded-[15px] bg-[#F3F3F3] text-[17px] font-[400] leading-[122%] text-[#ACA6A6] w-full py-[16px] px-8 outline-none" placeholder={t("formName")}/>
                    <PhoneInput required defaultCountry="uz" value={phone} onChange={(e) => setPhone(e)} name="phone" className="mb-[23px] rounded-[15px] bg-[#F3F3F3] text-[17px] font-[400] leading-[122%] text-[#ACA6A6] w-full py-[16px] px-8 outline-none" />
                    <textarea required value={message} onChange={(e) => setMessage(e.target.value)} name="message" className="mb-[23px] rounded-[15px] bg-[#F3F3F3] text-[17px] font-[400] leading-[122%] text-[#ACA6A6] w-full py-[16px] px-8 outline-none" placeholder={t("formMessage")} rows={10}></textarea>
